...
! function(t) {
    ...
    var h, g, I = navigator.userAgent.toLowerCase(),
        ...
        m = r.env.chrome = /chrome/.test(I) && /Google/.test(navigator.vendor) && parseInt(I.match(/chrome\/(\d+)\./)[1], 10),
    ...
    r.env.safari = /safari/.test(I) && !m && !_, y && s.on("touchstart mousedown", function(t) {
        h = t.target
        ...
        p = !0, v ? (v = !1, l.each(i, $)) : l.each(o, O), l.each(a, O), r.resize.up()
    }, r.load = function(t) {
        g.then(t)
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = $, e.removeAt = E, e.replaceAt = h, e.getIn = g, e.set = I, e.setIn = y, e.update = m, e.updateIn = _, e.merge = T, e.mergeDeep = O, e.mergeIn = S, e.omit = A, e.addDefaults = b;
    /*!
     * Timm
     *
    ...
    window.tram = function(t) {
        ...
        if (N.transition) {
            var R = N.timing.dom;
            if (O.style[R] = f["ease-in-back"][0], !O.style[R])
                for (var L in l) f[L][0] = l[L]
        }
        var C, x, w, P = e.frame = (C = d.requestAnimationFrame || d.webkitRequestAnimationFrame || d.mozRequestAnimationFrame || d.oRequestAnimationFrame || d.msRequestAnimationFrame) && N.bind ? C.bind(d) : function(t) {
                d.setTimeout(t, 16)
            },
            ...
            M = s(function(e) {
                ...
                e.init = function(e) {
                    if (this.$el = t(e), this.el = this.$el[0], this.props = {}, this.queue = [], this.style = "", this.active = !1, j.keepInherited && !j.fallback) {
                        var n = Y(this.el, "transition");
                        n && !_.test(n) && (this.upstream = n)
                    }
                    N.backface && j.hideBackface && H(this.el, N.backface.css, "hidden")
            ...
            F = s(function(t) {
                ...
                t.init = function(t, e, n, r) {
                    ...
                    var i, o, a = e[0],
                        c = "ease";
                    n[2] && (a = n[2]), z[a] && (a = z[a]), this.name = a, this.type = n[1], this.duration = u(e[1], this.duration, 500), this.ease = (i = e[2], void 0 !== (o = this.ease) && (c = o), i in f ? i : c), this.delay = u(e[3], this.delay, 0), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = T.test(this.name), this.unit = r.unit || this.unit || j.defaultUnit, this.angle = r.angle || this.angle || j.defaultAngle, j.fallback || r.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + " " + this.duration + "ms" + ("ease" != this.ease ? " " + f[this.ease][0] : "") + (this.delay ? " " + this.delay + "ms" : ""))
                }, t.set = function(t) {
            ...
            X = s(F, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, Q.perspective && j.perspective && (this.current.perspective = j.perspective, H(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
        ...
        e.fallback = function(t) {
            ...
            j.agentTests.push("(" + t + ")");
            var e = RegExp(j.agentTests.join("|"), "i");
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (c.set(t, e), c.set(e, t); ++v < f;) {
            var h = t[v],
                g = e[v];
            if (a) var I = s ? a(g, h, v, e, t, c) : a(h, g, v, t, e, c);
            if (void 0 !== I) {
                if (I) continue;
                $ = !1;
                break
            ...
            if (E) {
                if (!i(e, function(t, e) {
                        if (!o(E, e) && (h === t || u(h, t, n, a, c))) return E.push(e)
                    })) {
                    $ = !1;
                    break
                }
    ...
    }, e.startEngine = to, e.stopEngine = ta, e.stopAllActionGroups = tv, e.stopActionGroup = t$, e.startActionGroup = tE;
    var a = o(n(30)),
        u = o(n(282)),
        c = o(n(94)),
        s = o(n(59)),
        ...
        y = i(n(309)),
        m = o(n(310)),
        _ = Object.keys(h.QuickEffectIds),
        T = function(t) {
            return _.includes(t)
        },
        O = h.IX2EngineConstants,
        S = O.COLON_DELIMITER,
        ...
        R = O.W_MOD_IX,
        L = g.IX2VanillaUtils,
        C = L.getAffectedElements,
        x = L.getElementId,
        w = L.getDestinationValues,
        P = L.observeStore,
        D = L.getInstanceId,
        M = L.renderHTMLElement,
        G = L.clearAllStyles,
        F = L.getMaxDurationItemIndex,
        V = L.getComputedStyle,
        k = L.getInstanceOrigin,
        X = L.reduceListToGroup,
        U = L.shouldNamespaceEventParameter,
        B = L.getNamespacedParameterId,
        W = L.shouldAllowMediaQuery,
        j = L.cleanupHTMLElement,
        H = L.stringifyTarget,
        Y = L.mediaQueriesEqual,
    ...
    function to(t) {
        var e, n, i, o, a, u, l, d, p = t.store,
            ...
            _ = t.allowEvents,
            O = t.testManual,
            b = p.getState().ixSession;
        g && p.dispatch((0, I.rawDataImported)(g)), b.active || (p.dispatch((0, I.sessionInitialized)({
            hasBoundaryNodes: Boolean(document.querySelector(A)),
            reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches
        })), _ && (i = (n = p).getState().ixData.eventTypeMap, ts(n), (0, v.default)(i, function(t, e) {
            var i = m.default[e];
            i ? function(t) {
                var e = t.logic,
                    n = t.store,
                ...
                if ((0, f.default)(d)) {
                    (0, v.default)(d, function(t, e) {
                        ...
                        Y(p, u.mediaQueryKeys) || n.dispatch((0, I.mediaQueriesDefined)()), a.actionTypeId === h.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(o.config) ? o.config : [o.config]).forEach(function(e) {
                            ...
                            a && t.forEach(function(t, i) {
                                var o, c, l, p, $, E, h, g, I, m, _, T, O, b, N, R, L, x, P, D, M;
                                c = (o = {
                                    store: n,
                                    eventStateKey: f + S + i,
                                    eventTarget: t,
                                    ...
                                    smoothing: u,
                                    restingValue: d
                                }).store, l = o.eventStateKey, p = o.eventTarget, $ = o.eventId, E = o.eventConfig, h = o.actionListId, g = o.parameterGroup, I = o.smoothing, m = o.restingValue, T = (_ = c.getState()).ixData, O = _.ixSession, N = (b = T.events[$]).eventTypeId, R = {}, L = {}, x = [], P = g.continuousActionGroups, D = g.id, U(N, E) && (D = B(l, D)), M = O.hasBoundaryNodes && p ? y.getClosestElement(p, A) : null, P.forEach(function(t) {
                                    var e = t.keyframe;
                        ...
                        }), (a.actionTypeId === h.ActionTypeConsts.GENERAL_START_ACTION || T(a.actionTypeId)) && tp({
                            store: n,
                            actionListId: v,
                            eventId: f
                        })
                    ...
                    var p = function(t) {
                            ...
                            tl(d, function(r, o, c) {
                                var s = i[o],
                                    ...
                                    l = s.action,
                                    d = s.mediaQueries;
                                if (W(void 0 === d ? u.mediaQueryKeys : d, e.mediaQueryKey)) {
                                    var p = function() {
            ...
            window.addEventListener(t, a), o.dispatch((0, I.eventListenerAdded)(window, [t, a]))
        }), a()), -1 === (e = document.documentElement).className.indexOf(R) && (e.className += " ".concat(R)), p.getState().ixSession.hasDefinedMediaQueries && P({
            store: u = p,
            select: function(t) {
        ...
        })), p.dispatch((0, I.sessionStarted)()), l = p, d = O, function t(e) {
            var n, r, i, o = l.getState(),
                a = o.ixSession,
                u = o.ixParameters;
            a.active && (l.dispatch((0, I.animationFrameChanged)(e, u)), d ? (n = l, r = t, i = P({
                store: n,
                select: function(t) {
    ...
    function ta(t) {
        ...
        e.active && (e.eventListeners.forEach(tu), t.dispatch((0, I.sessionStopped)()))
    }
    ...
    var tc = ["resize", "orientationchange"];
    ...
    function tv(t) {
        ...
        (0, v.default)(n, function(t) {
            if (!t.continuous) {
                var n = t.actionListId,
                    r = t.verbose;
                t8(t, e), r && e.dispatch((0, I.actionListPlaybackChanged)({
                    actionListId: n,
                    isPlaying: !1
                }))
            }
    ...
    function t$(t) {
        ...
        (0, v.default)(u, function(t) {
            ...
            if (t.actionListId === o && t.eventId === n && a) {
                ...
                t8(t, e), t.verbose && e.dispatch((0, I.actionListPlaybackChanged)({
                    actionListId: o,
                    isPlaying: !1
                }))
            }
    ...
    function tE(t) {
        ...
        c >= I.length && (0, s.default)($, "config.loop") && (c = 0), 0 === c && m && c++;
        var _ = (0 === c || 1 === c && m) && T(null === (e = $.action) || void 0 === e ? void 0 : e.actionTypeId) ? $.config.delay : void 0,
            O = (0, s.default)(I, [c, "actionItems"], []);
        if (!O.length || !W(h, v.mediaQueryKey)) return !1;
    ...
    function th(t) {
        var e, n, r = t.store,
            ...
            O = (g[T] || {}).refState,
            S = y.getRefType(c),
            A = m.reducedMotion && h.ReducedMotionTypes[s.actionTypeId];
        if (A && d) switch (null === (e = _.events[v]) || void 0 === e ? void 0 : e.eventTypeId) {
        ...
        var b, N, R, L = k(c, O, i, s, y, l);
        r.dispatch((0, I.instanceAdded)((0, a.default)({
            instanceId: $,
            elementId: T,
            origin: L,
            refType: S,
            skipMotion: A,
            skipToValue: n
        }, o))), tg(document.body, "ix2-animation-started", $), f ? (b = r, N = $, R = b.getState().ixParameters, b.dispatch((0, I.instanceStarted)(N, 0)), b.dispatch((0, I.animationFrameChanged)(performance.now(), R)), tI(b.getState().ixInstances[N], b)) : (P({
            store: r,
            select: function(t) {
                return t.ixInstances[$]
            },
            onChange: tI
        }), d || r.dispatch((0, I.instanceStarted)($, m.tick)))
    }
    ...
    function t8(t, e) {
        ...
        var n = t.elementId,
            ...
            o = i.ref;
        i.refType === b && j(o, r, y), e.dispatch((0, I.instanceRemoved)(t.id))
    }
    ...
    function tI(t, e) {
        var n = t.active,
            ...
            _ = m.ixData,
            T = m.ixSession,
            O = (_.events[l] || {}).mediaQueries;
        if (W(void 0 === O ? _.mediaQueryKeys : O, T.mediaQueryKey) && (r || n || i)) {
            if (s || c === N && i) {
            ...
            if (i) {
                if ($) {
                    ...
                    h && !x && e.dispatch((0, I.actionListPlaybackChanged)({
                        actionListId: v,
                        isPlaying: !1
                    }))
                }
    ...
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(p) && u.hostname !== p && (d = !0), d && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
    ...
    "use strict";
    var r, i, o, a, u, c, s, f, l, d, p, v, $, E, h, g, I, y, m, _ = window.$,
        T = n(68) && _.tram;
    /*!
    ...
    t.exports = (r = {
        ...
        t.replace(i, function(e, n, r, i, u) {
            return a += t.slice(o, u).replace(y, m), o = u + e.length, n ? a += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? a += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : i && (a += "';\n" + i + "\n__p+='"), e
    ...
    r.define("edit", t.exports = function(t, e, n) {
        ...
        var i, o = t(window),
            ...
            s = n.load || function() {
                ...
                }, (n = window.document.createElement("iframe")).src = "https://webflow.com/site/third-party-cookie-check.html", n.style.display = "none", n.sandbox = "allow-scripts allow-same-origin", r = function t(r) {
            ...
            ready: function() {
                if ("undefined" != typeof document) try {
                    ...
                    ! function t(e) {
                        ...
                        function f(t) {
                            t.target.nodeName && "html" === t.target.nodeName.toLowerCase() || (n = !1, document.removeEventListener("mousemove", f), document.removeEventListener("mousedown", f), document.removeEventListener("mouseup", f), document.removeEventListener("pointermove", f), document.removeEventListener("pointerdown", f), document.removeEventListener("pointerup", f), document.removeEventListener("touchmove", f), document.removeEventListener("touchstart", f), document.removeEventListener("touchend", f))
                        }
                        document.addEventListener("keydown", function(t) {
                            t.metaKey || t.altKey || t.ctrlKey || (a(e.activeElement) && u(e.activeElement), n = !0)
                            ...
                            "hidden" === document.visibilityState && (r && (n = !0), s())
                        }, !0), s(), e.addEventListener("focus", function(t) {
                            var e, r, i;
                            a(t.target) && (n || (r = (e = t.target).type, "INPUT" === (i = e.tagName) && o[r] && !e.readOnly || "TEXTAREA" === i && !e.readOnly || e.isContentEditable)) && u(t.target)
                        }, !0), e.addEventListener("blur", function(t) {
                            var e;
    ...
    t.exports = function(t, e) {
        var n, r;
        if ("string" === e && o(n = t.toString) && !a(r = i(n, t)) || o(n = t.valueOf) && !a(r = i(n, t)) || "string" !== e && o(n = t.toString) && !a(r = i(n, t))) return r;
    ...
    (t.exports = function(t, e, n, c) {
        ...
        i(n) && ("Symbol(" === String(E).slice(0, 7) && (E = "[" + String(E).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!o(n, "name") || f && n.name !== E) && a(n, "name", E), (s = d(n)).source || (s.source = p.join("string" == typeof E ? E : ""))), t !== r ? (l ? !$ && t[e] && (v = !0) : delete t[e], v ? t[e] = n : a(t, e, n)) : v ? t[e] = n : u(e, n)
    ...
    var r, i, o, a = n(158),
        ...
        E = u.WeakMap;
    if (a || d.state) {
        var h = d.state || (d.state = new E),
            g = c(h.get),
            I = c(h.has),
            y = c(h.set);
        r = function(t, e) {
            if (I(h, t)) throw new $("Object already initialized");
            return e.facade = t, y(h, t, e), e
        }, i = function(t) {
            return g(h, t) || {}
        }, o = function(t) {
            return I(h, t)
        ...
        v[m] = !0, r = function(t, e) {
            if (l(t, m)) throw new $("Object already initialized");
    ...
    t.exports = {
        ...
        getterFor: function(t) {
            return function(e) {
                var n;
                if (!s(e) || (n = i(e)).type !== t) throw $("Incompatible receiver, " + t + " required");
                return n
            }
        }
    }
    ...
    var r, i = n(29),
        ...
        v = function() {
            ...
            v = "undefined" != typeof document ? document.domain && r ? p(r) : ((n = s("iframe")).style.display = "none", c.appendChild(n), n.src = String("javascript:"), (e = n.contentWindow.document).open(), e.write(d("document.F=Object")), e.close(), e.F) : p(r);
            for (var e, n, i = a.length; i--;) delete v.prototype[a[i]];
            return v()
        };
    u[f] = !0, t.exports = Object.create || function(t, e) {
        var n;
        return null !== t ? (l.prototype = i(t), n = new l, l.prototype = null, n[f] = t) : n = v(), void 0 === e ? n : o(n, e)
    }
}, function(t, e, n) {
    var r = n(13),
        i = n(28),
    ...
    "use strict";
    n.r(e);
    var r = Object(n(180).default)(Object.getPrototypeOf, Object);
    e.default = r
}, function(t, e, n) {
    "use strict";
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case c:
                var h = e.payload.step;
                return (0, i.set)(t, "tick", t.tick + (void 0 === h ? 20 : h));
            case s:
                return E;
            case d:
                var g = e.payload.now;
            ...
            case l:
                var y = e.payload,
                    m = y.stateKey,
                    _ = y.newState;
                return (0, i.setIn)(t, ["eventState", m], _);
            case p:
                var T = e.payload,
                    O = T.actionListId,
                    S = T.isPlaying;
            ...
            case v:
                for (var A = e.payload, b = A.width, N = A.mediaQueries, R = N.length, L = null, C = 0; C < R; C++) {
                    var x = N[C],
                        w = x.key,
                        P = x.min,
                        D = x.max;
    ...
    t.exports = function(t, e, n, $, E, h) {
        ...
        if (O && !_) return h || (h = new r), g || f(t) ? i(t, e, n, $, E, h) : o(t, e, y, n, $, E, h);
        if (!(1 & n)) {
            var S = _ && v.call(t, "__wrapped__"),
                A = T && v.call(e, "__wrapped__");
            if (S || A) {
                var b = S ? t.value() : t,
                    N = A ? e.value() : e;
                return h || (h = new r), E(b, N, n, $, h)
            }
        }
        return !!O && (h || (h = new r), a(t, e, n, $, E, h))
    }
}, function(t, e, n) {
    var r = n(50),
        i = n(226),
    ...
    t.exports = function(t, e, n, o, a, u) {
        ...
        for (var E = c; ++l < f;) {
            var h = t[d = s[l]],
                g = e[d];
            if (o) var I = c ? o(g, h, d, e, t, u) : o(h, g, d, t, e, u);
            if (!(void 0 === I ? h === g || a(h, g, n, o, u) : I)) {
                $ = !1;
                break
            }
            E || (E = "constructor" == d)
        ...
        if ($ && !E) {
            var y = t.constructor,
                m = e.constructor;
            y != m && "constructor" in t && "constructor" in e && !("function" == typeof y && y instanceof y && "function" == typeof m && m instanceof m) && ($ = !1)
        }
        return u.delete(t), u.delete(e), $
    }
}, function(t, e, n) {
    var r = n(102),
        i = n(103),
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.createElementState = y, e.mergeActionState = m, e.ixElements = void 0;
    var r = n(21),
        i = n(3),
    ...
    function m(t, e, n, i, o) {
        var a, u, c = (u = (a = o).config, _.reduce(function(t, e) {
            var n = e[0],
                r = e[1],
                i = u[n],
                o = u[r];
        ...
        switch (e.type) {
            ...
            case h:
                var n = e.payload,
                    ...
                    s = u.actionTypeId,
                    f = t;
                return (0, r.getIn)(f, [i, o]) !== o && (f = y(f, o, c, i, u)), m(f, i, s, a, u);
            case g:
                var l = e.payload;
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        var e = t.store,
            ...
            c = n(a());
        return u
    }, e.getAffectedElements = t8, e.getComputedStyle = function(t) {
        var e = t.element,
            n = t.actionItem;
        ...
        var e, n, r, i, o, a, u, c, s, l, d, p, v = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            g = (arguments.length > 4 ? arguments[4] : void 0).getStyle,
            I = E.actionTypeId,
            y = E.config;
        if ((0, h.isPluginType)(I)) return (0, h.getPluginOrigin)(I)(v[I]);
        switch (I) {
            case Z:
            case J:
            case tt:
            case te:
                return v[I] || t_[I];
            case tr:
                return tI(v[I], E.config.filters);
            case tn:
                return {
                    value: (0, f.default)(parseFloat(g(t, L)), 1)
                };
            case ti:
                var m, _, T = g(t, x),
                    O = g(t, w);
                return m = y.widthUnit === B ? tg.test(T) ? parseFloat(T) : parseFloat($.width) : (0, f.default)(parseFloat(T), parseFloat($.width)), _ = y.heightUnit === B ? tg.test(O) ? parseFloat(O) : parseFloat($.height) : (0, f.default)(parseFloat(O), parseFloat($.height)), {
                    widthValue: m,
                    heightValue: _
                };
            case to:
            ...
            case tu:
                return o = (e = {
                    ...
                    computedStyle: $,
                    getStyle: g
                }).element, a = e.actionTypeId, u = e.computedStyle, c = e.getStyle, l = c(o, s = tl[a]), d = tS.test(l) ? l : u[s], p = (n = tA, r = d, (i = n.exec(r)) ? i[1] : "").split(W), {
            ...
            case tc:
                return {
                    value: (0, f.default)(g(t, X), $.display)
                };
            case ts:
                return v[I] || {
                    value: 0
        ...
        switch (i) {
            ...
            case ti:
                ...
                if (d === B) {
                    var I = c(e, x);
                    s(e, x, ""), $ = f(e, "offsetWidth"), s(e, x, I)
                }
                if (p === B) {
                    var y = c(e, w);
                    s(e, w, ""), E = f(e, "offsetHeight"), s(e, w, y)
                }
                return {
            ...
            case tu:
                var m, _ = n.config,
                    ...
                    O = _.gValue;
                return {
                    rValue: T, gValue: O, bValue: _.bValue, aValue: _.aValue
                };
            case tr:
                return n.config.filters.reduce(ty, {});
            default:
                return {
        ...
        switch (u) {
            case Y:
                var s, f, d, p, v, $, E, I, y, m, L, P, D;
                return s = t, f = e, d = n, p = i, v = a, P = t0.map(function(t) {
                    var e = t_[t],
                        n = f[t] || {},
                        r = n.xValue,
                    ...
                    switch (t) {
                        case Z:
                            return "".concat(_, "(").concat(i).concat(l, ", ").concat(a).concat(p, ", ").concat(c).concat($, ")");
                        case J:
                            return "".concat(T, "(").concat(i).concat(l, ", ").concat(a).concat(p, ", ").concat(c).concat($, ")");
                        case tt:
                            return "".concat(O, "(").concat(i).concat(l, ") ").concat(S, "(").concat(a).concat(p, ") ").concat(A, "(").concat(c).concat($, ")");
                        case te:
                            return "".concat(b, "(").concat(i).concat(l, ", ").concat(a).concat(p, ")");
                        default:
                            return ""
                    }
                }).join(" "), D = v.setStyle, void(tb(s, g.TRANSFORM_PREFIXED, v), D(s, g.TRANSFORM_PREFIXED, P), $ = p, E = d, I = $.actionTypeId, y = E.xValue, m = E.yValue, L = E.zValue, (I === Z && void 0 !== L || I === J && void 0 !== L || I === tt && (void 0 !== y || void 0 !== m)) && D(s, g.TRANSFORM_STYLE_PREFIXED, N));
            case K:
                    ...
                    switch (v) {
                        case ti:
                            var E = r.config,
                                ...
                                m = n.widthValue,
                                _ = n.heightValue;
                            void 0 !== m && (g === B && (g = "px"), tb(t, x, o), p(t, x, m + g)), void 0 !== _ && (y === B && (y = "px"), tb(t, w, o), p(t, w, _ + y));
                            break;
                        case tr:
                            a = t, u = n, c = $, s = o, f = (0, l.default)(u, function(t, e, n) {
                                return "".concat(t, " ").concat(n, "(").concat(e).concat(tO(n, c), ")")
                            }, ""), d = s.setStyle, tb(a, C, s), d(a, C, f);
                            break;
                        case to:
                        case ta:
                        case tu:
                            var T = tl[v],
                                O = Math.round(n.rValue),
                                S = Math.round(n.gValue),
                                A = Math.round(n.bValue),
                                b = n.aValue;
                            tb(t, T, o), p(t, T, b >= 1 ? "rgb(".concat(O, ",").concat(S, ",").concat(A, ")") : "rgba(".concat(O, ",").concat(S, ",").concat(A, ",").concat(b, ")"));
                            break;
                        default:
                            var N = $.unit;
                            tb(t, i, o), p(t, i, n.value + (void 0 === N ? "" : N))
                    }
                }(t, 0, n, i, o, a);
            case z:
                return function(t, e, n) {
                    var r = n.setStyle;
                    if (e.actionTypeId === tc) {
                        var i = e.config.value;
                        return void r(t, X, i === R && g.IS_BROWSER_ENV ? g.FLEX_PREFIXED : i)
                    }
                }(t, i, a);
            case Q:
                var M = i.actionTypeId;
                if ((0, h.isPluginType)(M)) return (0, h.renderPlugin)(M)(c, e, i)
        }
        ...
        if (o === ti) {
            var a = e.config;
            a.widthUnit === B && r(t, x, ""), a.heightUnit === B && r(t, w, "")
        }
        i(t, U) && tC({
            effect: tN,
            actionTypeId: o,
    ...
    }, e.getMaxDurationItemIndex = tw, e.getActionListProgress = function(t, e) {
        ...
        var n = e.basedOn;
        return t === $.EventTypeConsts.SCROLLING_IN_VIEW && (n === $.EventBasedOn.ELEMENT || null == n) || t === $.EventTypeConsts.MOUSE_MOVE && n === $.EventBasedOn.ELEMENT
        ...
        var e = t.id,
            n = t.selector,
            r = t.useEventTarget;
        return (void 0 === e ? "" : e) + H + (void 0 === n ? "" : n) + H + (void 0 === r ? "" : r)
    ...
    var f = s(n(269)),
        ...
        tr = q.STYLE_FILTER,
        ti = q.STYLE_SIZE,
        to = q.STYLE_BACKGROUND_COLOR,
        ta = q.STYLE_BORDER,
        tu = q.STYLE_TEXT_COLOR,
        tc = q.GENERAL_DISPLAY,
        ts = "OBJECT_VALUE",
        tf = function(t) {
            return t.trim()
        },
        tl = Object.freeze((r = {}, (0, c.default)(r, to, P), (0, c.default)(r, ta, D), (0, c.default)(r, tu, M), r)),
        td = Object.freeze((i = {}, (0, c.default)(i, g.TRANSFORM_PREFIXED, m), (0, c.default)(i, P, y), (0, c.default)(i, L, L), (0, c.default)(i, C, C), (0, c.default)(i, x, x), (0, c.default)(i, w, w), i)),
        tp = {},
        tv = 1,
        t$ = 1,
        tE = function(t, e) {
    ...
    function t8(t) {
        var e, n, r, i = t.config,
            ...
            u = t.elementRoot,
            c = t.elementApi;
        if (!c) throw Error("IX2 missing elementApi");
        var s = i.targets;
        ...
        var m = th(y),
            ...
            A = m.appliesTo,
            b = m.useEventTarget;
        if (T) return [tp[T] || (tp[T] = {})];
        if (A === $.EventAppliesTo.PAGE) {
            var N = f(_);
            return N ? [N] : []
        }
        var R, L, C, x = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[_ || O] || {},
            w = Boolean(x.id || x.selector),
            P = o && l(th(o.target));
        if (w ? (R = x.limitAffectedElements, L = P, C = l(x)) : L = C = l({
                id: _,
                selector: O,
                selectorGuids: S
            }), o && b) {
            var D = a && (C || !0 === b) ? [a] : d(P);
            if (C) {
                if (b === k) return d(C).filter(function(t) {
                    return D.some(function(e) {
                        return h(t, e)
                    })
                });
                if (b === G) return d(C).filter(function(t) {
                    return D.some(function(e) {
                        return h(e, t)
                    })
                });
                if (b === V) return d(C).filter(function(t) {
                    return D.some(function(e) {
                        return I(e, t)
                    })
                })
        ...
        return null == L || null == C ? [] : g.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : R === G ? d(L, C) : R === F ? p(d(L)).filter(E(C)) : R === V ? v(d(L)).filter(E(C)) : d(C)
    }
    var tg = /px/,
        tI = function(t, e) {
    ...
    function tm(t) {
        return /^TRANSFORM_/.test(t) ? Y : /^STYLE_/.test(t) ? K : /^GENERAL_/.test(t) ? z : /^PLUGIN_/.test(t) ? Q : void 0
    }
    ...
    var t_ = (o = {}, (0, c.default)(o, Z, Object.freeze({
            xValue: 0,
            yValue: 0,
            zValue: 0
        ...
        if (g.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    ...
                    a = i(t, U);
                if (a) {
                    var u = a.split(W).map(tf); - 1 === u.indexOf(r) && o(t, U, u.concat(r).join(W))
                } else o(t, U, r)
            }
        }
    }
        ...
        if (g.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    o = n.setStyle,
                    a = i(t, U);
                a && -1 !== a.indexOf(r) && o(t, U, a.split(W).map(tf).filter(function(t) {
                    return t !== r
                }).join(W))
            }
        }
    ...
    function tL(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e, i = t.actionTypeId,
                o = t.config;
            e = (0, h.isPluginType)(i) ? (0, h.clearPlugin)(i) : tC({
                effect: tx,
                actionTypeId: i,
                elementApi: r
            }), t8({
    ...
    function tx(t, e, n) {
        var r = n.setStyle;
        tN(t, e, n), r(t, e, ""), e === g.TRANSFORM_PREFIXED && r(t, g.TRANSFORM_STYLE_PREFIXED, "")
    }
    ...
    var r = n(3),
        ...
        _ = function(t, e) {
            var n = t.position,
                ...
                h = p[r];
            null == h && (E = 1, h = c);
            var g, y, m, _, T = v((Math.max(h, 0) || 0) - n),
                O = l ? d : v(n + T * E),
                S = 100 * O;
            ...
            for (var A = 0, b = i.length; A < b; A++) {
                ...
                if (0 === A && (g = L[0]), S >= R) {
                    ...
                    var C = i[A + 1],
                        x = C && S !== R;
                    y = x ? C.actionItems[0] : null, x && (m = R / 100, _ = (C.keyframe - R) / 100)
                }
            }
            var w = {};
            if (g && !y)
                for (var P = 0, D = a.length; P < D; P++) {
                    var M = a[P];
                    w[M] = I(s, M, g.config)
                } else if (g && y && void 0 !== m && void 0 !== _)
                    for (var G = (O - m) / _, F = g.config.easing, V = $(F, G, f), k = 0, X = a.length; k < X; k++) {
                        var U = a[k],
                            B = I(s, U, g.config),
                            W = (I(s, U, y.config) - B) * V + B;
                        w[U] = W
                    }
            return (0, o.merge)(t, {
                position: O,
        ...
        T = function(t, e) {
            var n = t,
                ...
                _ = m.duration,
                T = m.delay;
            null != p && (_ = p), T = null != E ? E : T, c === h ? _ = 0 : (u || I) && (_ = T = 0);
            var O = e.payload.now;
            if (r && i) {
                var S = O - (a + T);
                if (s) {
                    var A = _ + T,
                        b = v(Math.min(Math.max(0, (O - a) / A), 1));
                    t = (0, o.set)(t, "verboseTimeElapsed", A * b)
                }
                if (S < 0) return t;
                var N = v(Math.min(Math.max(0, S / _), 1)),
                    R = $(y, N, g),
                    L = {},
                    C = null;
                return d.length && (C = d.reduce(function(t, e) {
                    ...
                    return t[e] = o, t
                }, {})), L.current = C, L.position = N, 1 === N && (L.active = !1, L.complete = !0), (0, o.merge)(t, L)
            }
            return t
        };
    e.ixInstances = function() {
        ...
        switch (e.type) {
            ...
            case l:
                ...
                if (!t[H]) return t;
                for (var Y = {}, z = Object.keys(t), K = z.length, Q = 0; Q < K; Q++) {
                    var q = z[Q];
                    q !== H && (Y[q] = t[q])
                }
                return Y;
            case d:
                for (var Z = t, J = Object.keys(t), tt = J.length, te = 0; te < tt; te++) {
                    var tn = J[te],
                        tr = t[tn],
                        ti = tr.continuous ? _ : T;
                    Z = (0, o.set)(Z, tn, ti(tr, e))
                }
                return Z;
            default:
                return t
    ...
    t.exports = function(t, e, n) {
        ...
        return e = o(e) || 0, r(n) && ($ = !!n.leading, f = (E = "maxWait" in n) ? a(o(n.maxWait) || 0, e) : f, h = "trailing" in n ? !!n.trailing : h), _.cancel = function() {
    ...
    var f, l, d, p = s(n(30)),
        ...
        D = m.NAVBAR_OPEN,
        M = m.MOUSE_MOVE,
        G = m.PAGE_SCROLL_DOWN,
        F = m.SCROLL_INTO_VIEW,
        V = m.SCROLL_OUT_OF_VIEW,
        k = m.PAGE_SCROLL_UP,
        X = m.SCROLLING_IN_VIEW,
        U = m.PAGE_FINISH,
        B = m.ECOMMERCE_CART_CLOSE,
        W = m.ECOMMERCE_CART_OPEN,
        j = m.PAGE_START,
        H = m.PAGE_SCROLL,
        Y = "COMPONENT_ACTIVE",
        ...
        td = function(t) {
            return function(e, n) {
                var r = e.nativeEvent.type,
                    i = -1 !== [Y, z].indexOf(r) ? r === Y : n.isActive,
                    o = (0, p.default)({}, n, {
                        isActive: i
                    });
        ...
        t8 = (0, p.default)({}, tu, {
            handler: (d = function(t, e) {
                var n = e.elementVisible,
                    r = t.event;
                return !t.store.getState().ixData.events[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === F === n ? (tn(t), (0, p.default)({}, e, {
                    triggered: !0
                })) : e
            }, function(t, e) {
                var n = (0, p.default)({}, e, {
        ...
        tg = (r = {}, (0, u.default)(r, L, tE()), (0, u.default)(r, C, th()), (0, u.default)(r, R, tE()), (0, u.default)(r, N, th()), (0, u.default)(r, D, tE(!1)), (0, u.default)(r, P, th(!1)), (0, u.default)(r, x, tE()), (0, u.default)(r, w, th()), (0, u.default)(r, W, {
        ...
        }), (0, u.default)(r, O, (0, p.default)({}, ti, {
            types: "mousedown"
            ...
            handler: function(t) {
                ...
                switch (u) {
                    case h.EventBasedOn.VIEWPORT:
                        O = _ ? Math.min(p, window.innerWidth) / window.innerWidth : Math.min($, window.innerHeight) / window.innerHeight;
                        break;
                    case h.EventBasedOn.PAGE:
                        var b = ts(),
                            ...
                            L = b.scrollWidth,
                            C = b.scrollHeight;
                        O = _ ? Math.min(N + g, L) / L : Math.min(R + m, C) / C;
                        break;
                ...
                return T && (O > .95 || O < .05) && (O = Math.round(O)), (u !== h.EventBasedOn.ELEMENT || A || A !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, I.parameterChanged)(S, O))), {
                    elementHovered: A,
                    clientX: p,
                    clientY: $,
                    pageX: g,
            ...
            handler: function(t) {
                ...
                var A = Q(i, v),
                    ...
                    R = (g ? O : 0) / 100;
                N = $ ? N : 1 - N, R = E ? R : 1 - R;
                var L = b.top + Math.min(b.height * N, l),
                    C = Math.min(l + (b.top + b.height * R - L), f),
                    x = Math.min(Math.max(0, l - L), C) / C;
                return x !== o.scrollPercent && n.dispatch((0, I.parameterChanged)(A, x)), {
                    scrollPercent: x
                }
            }
        }), (0, u.default)(r, F, t8), (0, u.default)(r, V, t8), (0, u.default)(r, G, (0, p.default)({}, tu, {
            handler: tv(function(t, e) {
                e.scrollingDown && tn(t)
            })
        })), (0, u.default)(r, k, (0, p.default)({}, tu, {
            handler: tv(function(t, e) {
                e.scrollingDown || tn(t)
            })
        })), (0, u.default)(r, U, {
    ...
    r.define("scroll", t.exports = function(t) {
        ...
        var v = /^#[a-zA-Z0-9][\w:.-]*$/,
            $ = "function" == typeof window.matchMedia && window.matchMedia("(prefers-reduced-motion: reduce)");
        ...
        function h(e) {
            ...
            if (!(r.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                ...
                if ("" !== l) {
                    var d, p = t(l);
                    p.length && (e && (e.preventDefault(), e.stopPropagation()), d = l, n.hash !== d && i && i.pushState && (!r.env.chrome || "file:" !== n.protocol) && (i.state && i.state.hash) !== d && i.pushState({
                        hash: d
                        ...
                        ! function(e, n) {
                            ...
                            if (r !== i) {
                                var a = function(t, e, n) {
                                        if ("none" === document.body.getAttribute("data-wf-scroll-motion") || $.matches) return 0;
                                        var r = 1;
                                    ...
                                    s = Date.now();
                                c(function t() {
                                    var e, o, u, f, l, d = Date.now() - s;
                                    window.scroll(0, (e = r, o = i, u = d, f = a, u > f ? o : e + (o - e) * ((l = u / f) < .5 ? 4 * l * l * l : (l - 1) * (2 * l - 2) * (2 * l - 2) + 1))), d <= a ? c(t) : "function" == typeof n && n()
                                })
                            }
                        }(p, function() {
    ...
    events: {
        "e-2": {
            ...
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-1",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-3": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-2",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-4": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-3",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-5": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-4",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-7": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-5",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-8": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-6",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-9": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-7",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-10": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-8",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-11": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-9",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
        ...
        "e-12": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "60dd72519d9f9f3b8b0ae424|scroll-10",
                appliesTo: "ELEMENT",
                styleBlockIds: []
            },
            targets: [{
                ...
                continuousActionGroups: [{
                    ...
                    actionItems: [{
                        ...
                        config: {
                            ...
                            duration: 500,
                            target: {
                                id: "60dd72519d9f9f3b8b0ae424|jan2012"
                            },
                            value: 0,
                            unit: ""
                        }
